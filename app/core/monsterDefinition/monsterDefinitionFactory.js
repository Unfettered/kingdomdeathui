		...
		this.definitions = {
			...
			'Kingsmen': {
				'Level 1': {
					...
					HitLocation: [
						this.cardService.get("Acid Shot Discharge", 'Kingsmen', 'HitLocation'),
						this.cardService.get("Axe Blade", 'Kingsmen', 'HitLocation'),
						this.cardService.get("Battle Pressure", 'Kingsmen', 'HitLocation'),
						this.cardService.get("Battle Pressure", 'Kingsmen', 'HitLocation'),
						this.cardService.get("Battle Pressure", 'Kingsmen', 'HitLocation'),
			...
			'The Hand': {
				'Level 1': {
					...
					aiDecks: {
						starter: [
							this.cardService.get('Applause', 'The Hand', 'AI', 'starter'),
